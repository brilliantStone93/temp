...
public class ChatServer {
	...
	private List<ChatHandler> list; // 접속자 수 만큼 생성된 ChatHandler를 담아줄 그릇
	...
	public ChatServer() {
		try {
			...
			while(true) {
				...
				ChatHandler handler = new ChatHandler(socket, list); //클라이언트가 들어오면 서버는 소켓을 생성하고 소켓과 리스트를 handler에 보내주어
