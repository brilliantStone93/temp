...
//	final static int NUMBER_OF_CLASS = 4;
//	final static int STUDENT_NUMBER_OF_CLASS = 10;
//	public static void main(String[] args) throws NumberFormatException, IOException {
//		BufferedReader br = new BufferedReader ( new InputStreamReader(System.in));
//		
//		int[][] koreanArray = new int [NUMBER_OF_CLASS][STUDENT_NUMBER_OF_CLASS];
//		int[][] englishArray = new int [NUMBER_OF_CLASS][STUDENT_NUMBER_OF_CLASS];
//		int[][] mathArray = new int [NUMBER_OF_CLASS][STUDENT_NUMBER_OF_CLASS];
//		
//		//매뉴
//		while(true) {
//		showMenu();
...
//			int studentNumber = selectStudent(br);
//			koreanArray [classNumber-1] = new int [studentNumber];
//			englishArray [classNumber-1] = new int [studentNumber];
//			mathArray [classNumber-1] = new int [studentNumber];
//			
//			
//			int korean = 0;
//			int english = 0;
...
//				case 1 : 
//					System.out.print("국어");
//					korean = inputScore(br);
//					break;
//				case 2 : 
//					System.out.print("영어");
//					english = inputScore(br);
//					break;
//				case 3 : 
//					System.out.print("수학");
//					math = inputScore(br);
//					break;
//				}
//			koreanArray [classNumber-1][studentNumber-1] = korean;
//			englishArray [classNumber-1][studentNumber-1] = english;
//			mathArray [classNumber-1][studentNumber-1] = math;
//			}//for
//		
//		}//if
//		else if(choice == 2) {//출력
//			int classNumber = selectClass(br);
//			if(koreanArray[classNumber-1] == null) {
//				System.out.println("아직 해당 반은 입력이 되어있지 않습니다.");
//				
//			}else {
//				for(int i = 0; i < koreanArray[classNumber-1].length; i++) {
//					System.out.println(koreanArray[classNumber-1][i]+1+"반");
//					System.out.println("학생"+(i+1));
//					System.out.println("국어점수 : "+koreanArray[classNumber-1][i]);
//					System.out.println("영어점수 : "+englishArray[classNumber-1][i]);
//					System.out.println("수학점수 : "+mathArray[classNumber-1][i]);
//				}
//				}
//			
//		}
...
//		System.out.println(">");
//	}
//	static int selectClass(BufferedReader br) throws NumberFormatException, IOException {
//		System.out.print("반을 선택하세요 : ");
//		int classNumber = Integer.parseInt(br.readLine());
//		while(true) {
//			if(classNumber>NUMBER_OF_CLASS || classNumber<0) {
//				System.out.println("잘 못 입력하셨습니다");
//				System.out.print("반을 선택하세요(1부터" +NUMBER_OF_CLASS+"까지) : ");
//				System.out.println("> ");
...
//		return classNumber;
//	}
//	static int selectStudent(BufferedReader br) throws NumberFormatException, IOException {
//		System.out.println("학생 숫자를 선택하세요");
//		int student = Integer.parseInt(br.readLine());
//		while(student > STUDENT_NUMBER_OF_CLASS || student < 0) {
//			System.out.println("잘 못 입력하셨습니다");
//			System.out.println("학생 숫자를 선택하세요");
...
//		return student;
//	}
//	static int inputScore(BufferedReader br) throws NumberFormatException, IOException {
