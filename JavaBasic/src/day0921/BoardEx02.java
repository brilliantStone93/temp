...
public class BoardEx02 {
   private static ArrayList<Board01> list;
   ...
   private static void update(int index) throws IOException {
      ...
      System.out.print("내용: ");
      list.get(index).setContents(bufferedReader.readLine());
      selectOne(index);
   }
   ...
   private static void add() throws NumberFormatException, IOException {
      ...
      b.setName(bufferedReader.readLine());

      System.out.print("글 내용: ");
      b.setContents(bufferedReader.readLine());
